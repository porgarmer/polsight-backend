"""
Django settings for electoral_sys_backend project.
...
STORAGES = {
    "default": {
        "BACKEND": os.getenv("DEFAULT_STORAGE", "django.core.files.storage.FileSystemStorage"),
    },
    "staticfiles": {
...
ROOT_URLCONF = 'electoral_sys_backend.urls'
